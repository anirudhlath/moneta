...
- **Views aggregate one currency:** `queries.primary_currency` picks the majority currency (ties prefer USD); networth/power/cashflow filter to it and net worth reports `foreign_accounts` excluded.
